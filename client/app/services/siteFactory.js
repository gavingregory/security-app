angular.module('logApp')
  .factory('siteFactory', function ($http) {
    return {
      list: function (id) {
        return $http.get('api/v1/customers/' + id + '/sites');
      },
      create: function (data) {
        return $http.post('api/v1/customers/' + data.customer_id + '/sites', data);
      },
      get: function (custId, siteId) {
        return $http.get('api/v1/customers/' + custId + '/sites/' + siteId);
      },
      update: function (data) {
        return $http.put('api/v1/customers/' + data.customer_id + '/sites/' + data._id, data);
      },
